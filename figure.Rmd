...
plot = ggplot(df, aes(variant, fold)) +
  ...
  ylab("Fold change (CP)")
plot1 = plot + geom_boxplot()
plot1
```


### CP indiv muts (Jittery)
```{r indiv-cp-jitter, fig.height=5, fig.retina=4, fig.width=5, message=FALSE, warning=FALSE, echo=FALSE}

plot2 = plot + geom_beeswarm()
plot2
```

### CP indiv muts (Jittery, Boxplot)
```{r indiv-cp-iqr-jitter, fig.height=5, fig.retina=4, fig.width=5, message=FALSE, warning=FALSE, echo=FALSE}

plot3 = plot + geom_boxplot() + geom_beeswarm()
plot3
```
...
```{r combo-cp-jitter, fig.height=5, fig.retina=4, fig.width=5, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r combo-cp-iqr-jitter, fig.height=5, fig.retina=4, fig.width=5, message=FALSE, warning=FALSE, echo=FALSE}
