...
mydata <- mutate(mydata,
       ...
       test_shape = ifelse(
         test_ic50 >= 10000 || test_ic50 <= 1, "diamond", "circle"),
       control_shape = ifelse(
         control_ic50 >= 10000 || control_ic50 <= 1, "diamond", "circle"),
...
plots[[3]] =  draw_plot(mydata, "LY-CoV1404", params = "No X")
