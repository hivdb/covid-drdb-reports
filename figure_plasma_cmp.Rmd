...
fold_df = read.dbTable('figure/figure_plasma_fold.csv', tables_dir=TABLEDIR) %>%
  filter(month=='1')
...
titer_df = read.dbTable('figure/figure_plasma_titer.csv', tables_dir=TABLEDIR) %>%
  filter(month=='1')
...
fold_df = read.dbTable('figure/figure_plasma_fold_indiv.csv', tables_dir=TABLEDIR) %>%
  filter(month=='1')
fold_df = fold_df %>%
  filter(variant %in% VARIANT) %>%
  filter(rx_name %in% RX_NAME_LIST)
...
titer_df = read.dbTable('figure/figure_plasma_titer_indiv.csv', tables_dir=TABLEDIR) %>%
  filter(month=='1')
titer_df = titer_df %>%
  filter(variant %in% VARIANT) %>%
  filter(rx_name %in% RX_NAME_LIST)
...
titer_df = read.dbTable('figure/figure_plasma_titer_points.csv', tables_dir=TABLEDIR) %>%
  filter(month=='1')
titer_df = titer_df %>%
  filter(variant %in% VARIANT) %>%
  filter(rx_name %in% RX_NAME_LIST)
...
titer_df = read.dbTable('figure/figure_plasma_titer_fold_points.csv', tables_dir=TABLEDIR) %>%
  filter(month=='1')
...
titer_other = read.dbTable('figure/figure_plasma_titer.csv', tables_dir=TABLEDIR) %>%
  filter(month=='>=2')
