...
### Pre Omicron, No history of infection, 2 shots

```{r nt-pre-omi-vac-2shot, fig.height=70, fig.retina=4, fig.width=18, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r nt-omi-vac-2ormore, fig.height=50, fig.retina=4, fig.width=18, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r nt-pre-omi-inf-vac-2ormore, fig.height=50, fig.retina=4, fig.width=18, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r nt-omi-inf-vac-2ormore, fig.height=50, fig.retina=4, fig.width=18, message=FALSE, warning=FALSE, echo=FALSE}
